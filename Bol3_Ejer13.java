...
public class Bol3_Ejer13 {
    ...
    public static void main(String[] args) throws Exception {// TODO Comprobacion neg y rangos
        ...
        do {
            ...
            while (dado1 == dado2) {
                dado2 = tirarDado(numeroCarasDado);
            }
            for (int i = 0; i < 3; i++) {
                do {
            ...
            PrintWriter fwriter = new PrintWriter("Ej13.txt");
            fwriter.printf("Nombre: %s,  Numero Caras Dado: %d, Numero Aciertos: %d", userName, numeroCarasDado,contadorNumerosAcertados);
            fwriter.close();
